import { EntityEquippableComponent, EntityHealthComponent, EquipmentSlot, world } from "@minecraft/server";
...
world.beforeEvents.worldInitialize.subscribe((data) => {
    ...
    itemComponentRegistry.registerCustomComponent("basic_addon:item_function", {
        onUse: (data) => {
            ...
            if (!entity) return
            const comp = entity.entity.getComponent(EntityHealthComponent.componentId) as EntityHealthComponent
            if (!comp) return
